    ...
    <div className="App">
      ...
      <div class="container">
        <div class="col-lg-12 text-center">
          <a href={require("../assets/Sharath_UIUX.pdf")} class="btn btn-primary" role="button" target="_blank">DOWNLOAD RESUME</a>
        </div>
        <br />
        ...
        <div><img class="mx-auto d-block" src={require("../assets/UIUXResume.jpg")} width="90%" /></div>
        <br />
        <div class="col-lg-12 text-center">
