  ...
  return (
    <div className="App">
      ...
      <div class="container-fluid">
        ...
        <div class="resumeheight"><img class="mx-auto d-block" src={require("../assets/Sharath_Resume_page-0001.jpg")} width="80%" /></div> <br/>
        <div class="resumeheight"><img class="mx-auto d-block" src={require("../assets/Sharath_Resume_page-0002.jpg")} width="80%" /></div>
        <br />
        <div class="col-lg-12 text-center">
