      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-7 intro">
            ...
            <p>My areas of interest are building <span>Websites</span> and <span>Data Analysis</span> and I'm also thinking of expanding my skillset in the domain of <span> App Development and Blockchain Development.</span></p>
